    ...
    <Screen>
      ...
      <ScreenBody className="flex flex-col pb-6">
        <div className="m-auto w-full max-w-md">
          <p className="mb-2.5 text-sm font-bold uppercase tracking-wider text-ink-3">
            {mn.setup.countLabel}
          </p>
            ...
            {Array.from({ length: MAX_PLAYERS }, (_, i) => i + 1).map((n) => {
              ...
              return (
                <button
                  ...
                  style={
                    {
                      "--btn-edge": selected ? "var(--accent-deep)" : "transparent",
                    } as CSSProperties
                  }
                  className={[
          ...
          <p className="mt-3 text-center text-xs text-ink-3">{mn.setup.hint}</p>
        </div>
      </ScreenBody>
